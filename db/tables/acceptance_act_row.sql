...
insert into acceptance_act_row(product_id, amount, price, expiration_date, note) values
(1, 1, 19.9, STR_TO_DATE('11/15/2021', '%m/%d/%Y'), 'Примечание к позиции 1'),
(1, 1, 19.9, STR_TO_DATE('11/16/2021', '%m/%d/%Y'), 'Примечание к позиции 2'),
(2, 3, 25.9, STR_TO_DATE('11/20/2021', '%m/%d/%Y'), 'Примечание к позиции 3');
